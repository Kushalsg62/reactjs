...
```bash
   npm start
```
4. Open `http://localhost:3000` in your browser (unless the project specifies another port)
...
- [Live Demo](https://moneymanagerprt.ccbp.tech/)

### 14. **Password Manager**
Secure password storage app with CRUD operations and local persistence
- [Live Demo](https://passwordmngprt.ccbp.tech/)
